...
If you already know what you are doing and just want the short version, this is the normal quick start after you are inside the repo:
...
running the app command from some unrelated directory where Python cannot see the local package correctly
